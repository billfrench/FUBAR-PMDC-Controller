...
void setup() {
  ...
  Serial.begin(9600);
  pinMode(3, OUTPUT);  //Tank full LED
  pinMode(2, OUTPUT);  //Shunt Amp Max LED
  pinMode(1, OUTPUT);  //Over amps or tank empty LED
  pinMode(0, OUTPUT);  //Over 40 amps, tank draining LED
